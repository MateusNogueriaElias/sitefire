        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {services.map((service, index) => (
              <Card key={index} className="hover-lift border-0 shadow-2xl h-full animate-scale-in glass-card group overflow-hidden" style={{ animationDelay: `${index * 200}ms` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="hover-lift border-0 shadow-2xl animate-scale-in glass-card group" style={{ animationDelay: `${index * 200}ms` }}>
