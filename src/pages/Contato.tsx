    ...
    <div className="overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <Card key={index} className="border-0 shadow-lg hover-lift animate-scale-in" style={{ animationDelay: `${index * 0.2}s` }}>
              ...
              {/* Response Time */}
              <Card className="border-0 shadow-lg fire-gradient text-white animate-scale-in" style={{ animationDelay: '0.6s' }}>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <Card key={index} className="border-0 shadow-lg hover-lift animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardContent className="p-6">
